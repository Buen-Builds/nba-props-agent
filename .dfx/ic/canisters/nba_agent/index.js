...
import { idlFactory } from './nba_agent.did.js';
export { idlFactory } from './nba_agent.did.js';
 ...
 * @return {import("@icp-sdk/core/agent").ActorSubclass<import("./nba_agent.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the nba_agent canister
 * @type {import("@icp-sdk/core/agent").ActorSubclass<import("./nba_agent.did.js")._SERVICE>}
 */
