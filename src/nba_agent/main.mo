...
persistent actor NBAAgent {
  ...
  func load_props() : [Prop] {[
    mp("Rudy Gobert",        "MIN", "Rebs+Asts",   8.5, 13.1, 0.90, 0.20, -600, "DET @ MIN",  "6:00pm"),
    mp("Karl-Anthony Towns", "MIN", "Rebs+Asts",  10.5, 14.2, 0.88, 0.20, -600, "DET @ MIN",  "6:00pm"),
    mp("Cade Cunningham",    "DET", "Rebs+Asts",   8.5, 11.3, 0.85, 0.30, -500, "DET @ MIN",  "6:00pm"),
    mp("Trae Young",         "ATL", "Rebs+Asts",  10.5, 13.8, 0.87, 0.25, -500, "SAC @ ATL",  "6:30pm"),
    mp("De'Aaron Fox",       "SAC", "Rebs+Asts",   6.5,  9.2, 0.86, 0.25, -500, "SAC @ ATL",  "6:30pm"),
    mp("Domantas Sabonis",   "SAC", "Rebs+Asts",  14.5, 18.6, 0.91, 0.20, -500, "SAC @ ATL",  "6:30pm"),
    ...
    mp("Kevin Durant",       "PHO", "Rebs+Asts",   8.5, 11.4, 0.88, 0.20, -500, "UTA @ PHO",  "8:00pm"),
    mp("Lauri Markkanen",    "UTA", "Rebs+Asts",   8.5, 11.8, 0.86, 0.30, -500, "UTA @ PHO",  "8:00pm"),
    mp("Devin Booker",       "PHO", "Points",      26.5, 29.4, 0.85, 0.20, -500, "UTA @ PHO",  "8:00pm"),
    mp("Victor Wembanyama",  "SA",  "PRA",         24.5, 32.8, 0.90, 0.15, -500, "SA @ MIL",   "7:00pm"),
    mp("Victor Wembanyama",  "SA",  "Rebs+Asts",  10.5, 14.6, 0.89, 0.15, -500, "SA @ MIL",   "7:00pm"),
    mp("Giannis Antetokounmpo","MIL","Rebs+Asts", 10.5, 14.8, 0.90, 0.20, -650, "SA @ MIL",   "7:00pm"),
    mp("Joel Embiid",        "PHI", "Rebs+Asts",  10.5, 13.2, 0.85, 0.20, -500, "PHI @ CHA",  "6:00pm"),
    mp("Tyrese Maxey",       "PHI", "Rebs+Asts",   6.5,  8.8, 0.86, 0.20, -500, "PHI @ CHA",  "6:00pm"),
    mp("LaMelo Ball",        "CHA", "Rebs+Asts",  10.5, 13.6, 0.85, 0.30, -500, "PHI @ CHA",  "6:00pm"),
    mp("Nikola Jokic",       "DEN", "PRA",         24.5, 51.3, 0.95, 0.15, -620, "DEN vs DAL", "8:00pm"),
    mp("Nikola Jokic",       "DEN", "Rebs+Asts",  15.5, 23.3, 0.94, 0.15, -620, "DEN vs DAL", "8:00pm"),
    mp("Luka Doncic",        "DAL", "PRA",         38.5, 43.2, 0.85, 0.20, -500, "DEN vs DAL", "8:00pm"),
    mp("Evan Mobley",        "CLE", "Rebs+Asts",  12.5, 15.8, 0.90, 0.15, -500, "CLE vs MIA", "6:00pm"),
    mp("Andrew Wiggins",     "MIA", "Pts+Rebs",   11.5, 16.8, 0.93, 0.20, -650, "CLE vs MIA", "6:00pm"),
    mp("Donovan Clingan",    "POR", "Rebs+Asts",  14.5, 18.2, 0.90, 0.20, -500, "POR vs MIL", "8:00pm")
  ]};
