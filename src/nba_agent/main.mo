...
persistent actor NBAAgent {
  ...
  func load_props() : [Prop] {[
    ...
    mp("Aaron Gordon", "???", "Rebs+Asts", 8.5, 9.6, 0.87, 0.20, -500, "CHA @ ORL", "11:30PM"),
    ...
    mp("Cameron Johnson", "???", "Rebs+Asts", 9.5, 10.7, 0.87, 0.20, -500, "CHA @ ORL", "11:30PM"),
    ...
    mp("Onyeka Okongwu", "???", "Rebs+Asts", 9.5, 10.7, 0.87, 0.20, -500, "CHA @ ORL", "11:30PM"),
    ...
    mp("VJ Edgecombe", "???", "Rebs+Asts", 9.5, 10.7, 0.87, 0.20, -500, "CHA @ ORL", "11:30PM"),
