...
persistent actor NBAAgent {
  ...
  func load_props() : [Prop] {[
    mp("Coby White",         "CHA", "Points",     10.5, 14.2, 1.00, 0.15, -500, "CHA @ ORL", "11:30PM"),
    mp("Brandin Podziemski", "GSW", "Points",     10.0, 13.8, 1.00, 0.15, -500, "GSW @ PHX", "02:00AM"),
    ...
    mp("Brandon Miller",     "CHA", "Points",     16.0, 22.0, 1.00, 0.15, -500, "CHA @ ORL", "11:30PM"),
    mp("Jordan Goodwin",     "PHX", "Points",      5.0,  8.4, 1.00, 0.15, -500, "GSW @ PHX", "02:00AM"),
    mp("Grayson Allen",      "PHX", "Points",      8.0, 11.8, 0.95, 0.15, -500, "GSW @ PHX", "02:00AM"),
    mp("Jalen Suggs",        "ORL", "Points",     10.0, 14.2, 0.86, 0.15, -500, "CHA @ ORL", "11:30PM"),
    mp("Desmond Bane",       "ORL", "Points",     15.0, 19.2, 0.80, 0.15, -500, "CHA @ ORL", "11:30PM"),
    ...
    mp("Jalen Green",        "HOU", "PRA",        19.5, 27.8, 1.00, 0.15, -800, "GSW @ PHX", "02:00AM"),
